...
shooting = pygame.mixer.Sound("Ping-pong-OpenCV-master\sound\pbounce.ogg")
...
background = pygame.image.load("Ping-pong-OpenCV-master\starfield.png").convert()
...
lower = np.array([60,25,30])
upper = np.array([255,220,255])
flag = 0
...
class ScoreBoard:
    def __init__(self, score=0):
        ...
        self.y = 20
        self.score = score
        self.font = pygame.font.Font('Ping-pong-OpenCV-master\FreeSans\FreeSansBold.ttf', 20)
...
def main():
    ...
    while cap.isOpened():
        ...
        cascade_file = cv2.CascadeClassifier("Ping-pong-OpenCV-master\dfist.xml")
